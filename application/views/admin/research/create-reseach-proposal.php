<div class="page-head">
	<h4 class="my-2"><?=$page_title;?></h4>
	<p>Input Title</p>
	<p>Input Name of Proponent/s</p>
	<p>Input College Affiliation</p>
	<p>Input Background of the Study</p>
	<p>Input Significant of the Study</p>
